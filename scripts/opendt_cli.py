...
def init(
    ...
    try:
        ...
        console.print(
            f"[green]✓[/green] Created metadata: {metadata_path.relative_to(project_root)}"
        )
    except Exception as e:
    ...
    try:
        ...
        if not workload_dir.exists():
            console.print(
                f"[bold red]Error:[/bold red] Workload directory not found: {workload_dir}"
            )
            raise typer.Exit(code=1)

        console.print(f"[green]✓[/green] Workload directory found: {workload_name}")
...
"""
    ...
    console.print(f"Workload: [bold]{workload_name}[/bold]")
