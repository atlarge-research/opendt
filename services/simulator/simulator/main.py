...
from odt_common.utils import get_kafka_consumer, get_kafka_producer

from simulator.result_cache import ResultCache
...
class SimulationService:
    ...
    def __init__(
        ...
        self.output_base_dir = Path(run_output_dir) / run_id / "opendc"
    ...
    def _run_simulation(self) -> None:
        ...
        # Create directories
        run_dir = self.output_base_dir / f"run_{self.run_number}"
...
def main():
    ...
    simulation_frequency_minutes = config.simulation.simulation_frequency_minutes
    run_output_dir = config.simulation.run_output_dir
